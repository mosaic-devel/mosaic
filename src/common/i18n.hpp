...
// The language init() actually selected: the $MOSAIC_LANG value when the override is in force,
// otherwise empty (meaning "whatever the system locale asked for"). Diagnostics only.
